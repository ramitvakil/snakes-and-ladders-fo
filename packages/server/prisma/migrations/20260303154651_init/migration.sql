...
CREATE TABLE "games" (
    ...
    "vix_level" REAL NOT NULL DEFAULT 18,
...
CREATE TABLE "turn_logs" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "turn_logs_game_id_fkey" FOREIGN KEY ("game_id") REFERENCES "games" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "turn_logs_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "game_players" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "leaderboard" (
    ...
    "highest_capital" REAL NOT NULL DEFAULT 100,
    "longest_streak" INTEGER NOT NULL DEFAULT 0,
    "total_capital_earned" REAL NOT NULL DEFAULT 0,
